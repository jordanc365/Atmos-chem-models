...
# Averages
v1 = vcon.mean(axis=(2, 3))*3.6
ter1 = tercon.mean(axis=(2, 3))*3.6


# Reshape array for month
rv1 = np.reshape(v1, 672)
rter1 = np.reshape(ter1, 672)
...
plt.plot(date21, totarr2, linestyle='-', linewidth=3.0, c='b', label=' CTM Biogenic Emissions')
 #KOEH Data

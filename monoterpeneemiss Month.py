# -*- coding: utf-8 -*-
"""
Create Monoterpene Timeseries MEGAN-Offline 
...
# [ time, source, lon, lat ]
v = (f.variables['ISOP'][1:28, 15:24, 0, :, 10:125]*68.12)
v2 = (f.variables['ISOP'][1:28, 0:15, 0, :, 10:125]*68.12)
ter = (f.variables['TERP'][1:28, 15:24, 0, :, 10:125]*136.298)
ter2 = (f.variables['TERP'][1:28, 0:15, 0, :, 10:125]*136.298)
...
rv1 = vcon.reshape(648, 128, 115)
rter1 = tercon.reshape(648,  128, 115 )
...
plt.plot(date21, ter1, linestyle='-', linewidth=2, c='c', label=' MEGAN-Offline Monoterpene Emissions')
plt.plot(date21, sm1, linestyle='-', linewidth=2, c='r', label=' CSIRO-CTM-MEGAN Monoterpene Emissions')
...
plt.fill_between(date21, sm1-stdevkmeg2, sm1+stdevkmeg2, alpha=0.3, edgecolor='black', 
...
plt.yticks(np.arange(0, 3.25, 0.25))  # use floats for y 

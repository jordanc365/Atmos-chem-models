# -*- coding: utf-8 -*-
"""
Create Timeseries MEGAN coupled to CTM
...
##############################################################################
plt.plot(date31, v1, linestyle='-', linewidth=2.0, c='c', label=' MEGAN-Offline Isoprene Emissions')
         
# Create standard devation fill
plt.fill_between(date31, v1-stdevjmeg1, v1+stdevjmeg1, alpha=0.3, edgecolor='black', 

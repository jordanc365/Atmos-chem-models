# -*- coding: utf-8 -*-
"""
Create average emissions map CTM 2013
...
jantot = np.sum(jan, axis=(0, 1,2,3))
...
martot = np.sum(mar, axis=(0, 1,2,3))
print martot/1000
...
aprtot = np.sum(apr, axis=(0, 1,2,3))
print aprtot/1000
...
maytot = np.sum(may, axis=(0, 1,2,3))
print maytot/1000
...
juntot = np.sum(jun, axis=(0, 1,2,3))
print juntot/1000
...
jultot = np.sum(jul, axis=(0, 1,2,3))
print jultot/1000
...
augtot = np.sum(aug, axis=(0, 1,2,3))
print augtot/1000
...
septot = np.sum(sep, axis=(0, 1,2,3))
print septot/1000
...
octtot = np.sum(oct, axis=(0, 1,2,3))
print octtot/1000
...
novtot = np.sum(nov, axis=(0, 1,2,3))
print novtot/1000
...
dectot = np.sum(dec, axis=(0, 1,2,3))
print dectot/1000
...
mocedata = maskoceans(mlons, mlats, st,  inlands=True, resolution='h',
                      grid=1.25)
